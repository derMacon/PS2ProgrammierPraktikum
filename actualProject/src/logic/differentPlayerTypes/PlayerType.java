...
public enum PlayerType {
     ...
     * @param boardStr board of the player
     * @param idx   index of the player in the game's player array
     * @param gui   reference to the gui
     * @return a player of the given type
     */
    public static Player loadPlayerInstanceWithGivenTypeAndBoard(PlayerType type, String boardStr,
                                                                 int idx, GUIConnector gui) {
        Player output = null;
        switch (type) {
            case HUMAN:
                output = new HumanPlayer(gui, idx, boardStr);
                break;
            case DEFAULT:

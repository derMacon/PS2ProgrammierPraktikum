...
Ein Konstruktur verbindet die Enum-Darstellung mit einem Distrikttypen und eine Anzahl an Punkten, welche auf dem betrachteten Tile verf"ugbar sind (siehe Listing \ref{lst:singleTile}).

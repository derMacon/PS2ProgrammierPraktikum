...
public class JavaFXGUI implements GUIConnector {
    ...
    protected static final Image EMPTY_IMG = new Image("main/gui/textures/EmptyV3.png");

    /**
     * Texture for the chip representing the selection of player 1
     */
    public static final Image SELECTION_PLAYER_1_TEXTURE = new Image("main/gui/textures/ChipPlayer1.png");

    /**
     * Texture for the chip representing the selection of player 1
     */
    public static final Image SELECTION_PLAYER_2_TEXTURE = new Image("main/gui/textures/ChipPlayer2.png");

    /**
     * Texture for the chip representing the selection of player 1
     */
    public static final Image SELECTION_PLAYER_3_TEXTURE = new Image("main/gui/textures/ChipPlayer3.png");

    /**
     * Texture for the chip representing the selection of player 1
     */
    public static final Image SELECTION_PLAYER_4_TEXTURE = new Image("main/gui/textures/ChipPlayer4.png");
...
//        this.imgVwsProvidedBank = imgVwsProvidedBank;
    ...
    private Image loadImage(int value) {
        ...
        switch (value) {
            case 0:
                img = new Image("main/gui/img/CityHall_Empty.png");
                break;
            case 1:
                img = EMPTY_IMG;
                break;
            case 2:
                img = new Image("main/gui/img/Amusement_0.png");
                break;
            case 3:
                img = new Image("main/gui/img/Amusement_1.png");
                break;
            case 4:
                img = new Image("main/gui/img/Amusement_2.png");
                break;
            case 5:
                img = new Image("main/gui/img/Amusement_3.png");
                break;
            case 6:
                img = new Image("main/gui/img/Industry_0.png");
                break;
            case 7:
                img = new Image("main/gui/img/Industry_1.png");
                break;
            case 8:
                img = new Image("main/gui/img/Industry_2.png");
                break;
            case 9:
                img = new Image("main/gui/img/Industry_3.png");
                break;
            case 10:
                img = new Image("main/gui/img/Office_0.png");
                break;
            case 11:
                img = new Image("main/gui/img/Office_1.png");
                break;
            case 12:
                img = new Image("main/gui/img/Office_2.png");
                break;
            case 13:
                img = new Image("main/gui/img/Office_3.png");
                break;
            case 14:
                img = new Image("main/gui/img/Park_0.png");
                break;
            case 15:
                img = new Image("main/gui/img/Park_1.png");
                break;
            case 16:
                img = new Image("main/gui/img/Park_2.png");
                break;
            case 17:
                img = new Image("main/gui/img/Park_3.png");
                break;
            case 18:
                img = new Image("main/gui/img/Shopping_0.png");
                break;
            case 19:
                img = new Image("main/gui/img/Shopping_1.png");
                break;
            case 20:
                img = new Image("main/gui/img/Shopping_2.png");
                break;
            case 21:
                img = new Image("main/gui/img/Shopping_3.png");
                break;
            case 22:
                img = new Image("main/gui/img/Home_0.png");
                break;
            case 23:
                img = new Image("main/gui/img/Home_1.png");
                break;
            case 24:
                img = new Image("main/gui/img/Home_2.png");
                break;
            case 25:
                img = new Image("main/gui/img/Home_3.png");
                break;
            default:
                img = EMPTY_IMG;
        }
